...
<div class="a">A)There are 29 direct children of the body tag.</div>

### b
<div class="q">What are the node names of the direct descendents of the `<body>`?</div>

```{r '1b'}
(nodeNames <- dc %>% html_tag())
```
...
get_yelp_sr_one_page("vegan",loc="Boston,MA",page=9)
```
