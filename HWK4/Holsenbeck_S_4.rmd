...
## Read Data
```{r 'Read Data'}
fmdb <- as.tibble(read.csv(file = "C:\\Users\\Stephen\\Documents\\Northeastern\\DA 5020 - Collect Store Retrieve Data\\Homework\\HWK4\\farmers_market.csv",na.strings="NA"))
```
## Warm-up
...
(OPStats <- fmdb %>% 
  group_by(State)%>%
summarize(Facebook = sum(Facebook != "")/n(),
          Twitter = sum(Twitter != "")/n()))
```
## Q4
