...
(fm_by_loc <- fmdb %>%
  group_by(Location) %>%
  summarise(Number = n()))
forcats::fct_recode(fm_by_loc$Location)
ggplot(data = fm_by_loc,mapping=aes(x=Location,y=Number))+
  geom_bar(stat="identity")+
  coord_flip()+
  scale_x_discrete(labels=c("NA","Private Lot","Other","On a Farm","Local Gov Bldg","Healthcare Bldg","Fed/State Gov Bldg","Faith Bldg", "Educational Bldg","Wholesale Mkt Bldg","Closed-off Public St"))+
  ylim(0,1000)
#flip Label Vector 2017-09-28 1333
